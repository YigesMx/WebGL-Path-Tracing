...
let createWebGLContext = function(canvas, message) {
...
let createProgram = function(context, vertexShaderSource, fragmentShaderSource, message) {
...
export {requestAnimFrame, createWebGLContext, createProgram};


// from original WebGL Utility
